...
import { fetchDataFromApi, sendDataFromApi, editDataFromApi, deleteDataFromApi } from '../../Utils/api';
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="left-contact">
            ...
            <form className="rd-mailform" onSubmit={editedBlogId ? handleSaveChanges : handleSubmit}>
              <div className="row">
